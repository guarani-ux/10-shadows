...
def test_build_routing_trigger():
    task_spec = {
        ...
        "deliverable": {"kind": "CODE", "description": "Python script for CSV cleaning"},
        "constraints": [],
        "knowns": [],
        "unknowns": [],
        "assumptions": [],
...
def test_build_capability_physical_smoke_test_pass(mock_model, temp_dir):
    ...
    task_spec = {
        ...
        "deliverable": {"kind": "CODE", "description": "Python data processor"},
        "constraints": [],
        "knowns": [],
        "unknowns": [],
        "assumptions": [],
...
def test_build_capability_physical_smoke_test_fail(mock_model, temp_dir):
    ...
    task_spec = {
        ...
        "deliverable": {"kind": "CODE", "description": "Broken script"},
        "constraints": [],
        "knowns": [],
        "unknowns": [],
        "assumptions": [],
